...
?>
<div class="wrap">
	<h1><?php _e( 'Add Renewal Notice', 'give-recurring' ); ?> - <a href="<?php echo admin_url( 'edit.php?post_type=give_forms&page=give-settings&tab=recurring' ); ?>" class="add-new-h2 add-new-h1"><?php _e( 'Go Back', 'give-recurring' ); ?></a></h1>

	<form id="give-add-renewal-notice" action="" method="post">
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<input name="subject" id="give-notice-subject" class="give-notice-subject" type="text" placeholder="<?php _e('Your Subscription is About to Renew', 'give') ?>" value="" style="min-width:300px;" />
		...
		<div class="give-submit-wrap submit">
			<input type="hidden" name="give-action" value="recurring_add_renewal_notice" />
			<input type="hidden" name="give-recurring-reminder-nonce" value="<?php echo wp_create_nonce( 'give_recurring_renewal_nonce' ); ?>" />
			<input type="submit" value="<?php _e( 'Add Renewal Notice', 'give-recurring' ); ?>" class="button-primary" />
		</div>
	</form>
</div>