...
function give_stripe_credit_card_form( $form_id, $echo = true ) {
	...
	if ( ! give_get_option( 'stripe_collect_billing' ) ) {
 ...
 *
 * @description: Create the Statement Description
 *
 ...
 * @return mixed|void
 */
function give_get_stripe_statement_descriptor( $purchase_data ) {

	$form_title = isset( $purchase_data['post_data']['give-form-title'] ) ? $purchase_data['post_data']['give-form-title'] : '';
	...
	return apply_filters( 'give_stripe_statement_descriptor', $statement_descriptor, $purchase_data );
